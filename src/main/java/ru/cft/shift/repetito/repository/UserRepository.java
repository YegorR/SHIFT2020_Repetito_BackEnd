...
public interface UserRepository extends JpaRepository<UserEntity, Long>, JpaSpecificationExecutor<UserEntity> {
    ...
    List<UserEntity> findByFilters(@Param("search") String search, @Param("course") long course, @Param("faculty") String faculty, @Param("degree") String degree, OffsetBasedPageRequest pageable);
